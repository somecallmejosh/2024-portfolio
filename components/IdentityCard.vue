  ...
  <div class="sticky pt-12 bg-white top-20 rounded-xl">
    ...
    <div class="-mt-14">
      <div class="px-4 mb-10 text-center">
        <h2 class="mb-1 text-xl font-bold">Joshua Briley</h2>
        <p class="font-medium text-gray-500">UI/UX Developer</p>
      </div>
      <ul class="px-12 pt-10 pb-12 space-y-4 font-medium text-left text-gray-600 bg-slate-50 rounded-b-2xl">
